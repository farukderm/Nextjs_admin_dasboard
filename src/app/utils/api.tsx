...
> => {
  ...
  if (!res.ok) {
    throw new Error(
      "Siparişler alınırken bir sorun oluştu"
    );
  }
...
> => {
  ...
  if (!res.ok) {
    throw new Error(
      "Ürünler alınırken bir sorun oluştu"
    );
  }
...
export const updateProduct = async (
  ...
  if (!res.ok) {
    throw new Error(
      "Ürün güncelleme işlemi başarısız"
    );
  }
...
> => {
  ...
  if (!res.ok) {
    throw new Error(
      "Kullanıcı verileri alınırken bir sorun oluştu"
    );
  }
...
export const deleteUser = async (
  ...
  if (!res.ok) {
    throw new Error(
      "Kullanıcı hesabı kaldırılırken bir sorun oluştu"
    );
  }
